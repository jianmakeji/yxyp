		...
		<div v-if="step != '3'">
			<row type="flex" justify="center" align="top" :gutter="60">
		        <i-col class="rules" span="8">
		        	...
		        	<div class="uploadRule_1" v-if="step === '1'">
		        		
		        	</div>
		        	<div class="uploadRule_2" v-if="step === '2'">
					...
					<div class="userInfo">
						<i-form :label-width="120">
							...
							<div v-if="step === '1'">
								...
								<form-item :label="participantName">
									<i-input v-model="formItem.participant_name" placeholder="请输入姓名"></i-input>
								</form-item>
								<form-item label="队员姓名" v-if="formItem.participant_type == '2'">
									<i-input v-model="formItem.team_member" placeholder="成员姓名用中文逗号连接"></i-input>
								</form-item>
								<form-item :label="participantIdNumber">
									<i-input v-model="formItem.participant_id_number" :placeholder="idNamePlaceholder"></i-input>
								</form-item>
								<form-item label="所属单位" v-if="formItem.participant_type != '3'">
									<i-input v-model="formItem.affiliatedUnit" placeholder="请输入所属单位"></i-input>
								</form-item>
								<form-item label="简介">
									<i-input type="textarea" v-model="formItem.participant_brief" placeholder="请输入个人简介"></i-input>
								</form-item>
								<form-item>

...
import com.jianma.yxyp.service.FindPwdService;
import com.jianma.yxyp.service.UserService;
import com.jianma.yxyp.util.GraphicsUtil;
...
public class UserController extends DcController {
	...
	public ListResultModel getDataTableUserByPage(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			PagingModel pagingModel = userServiceImpl.getUserByPage(offset, limit);
